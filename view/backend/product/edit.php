    ...
    <div class="row">
        <div class="form-group col-6">
            <label class="mt-3">MÃ NICK</label>
                <input class="form-control" name="ma_tai_khoan" readonly value="auto number" value="<?= $product['ma_tai_khoan'] ?>">
        </div>
        <div class="form-group col-6">
            <label class="mt-3">TÊN NICK</label>
            <input class="form-control" name="ten_tai_khoan" id="" value="<?= $product['ten_tai_khoan'] ?>">

        </div>
        <div class="form-group col-6">
            <label class="mt-3">PASSWORD</label>
            <input class="form-control" name="password" id="" type="password" value="<?= $product['password'] ?>">
        ...
        <div class="form-group col-6">
            ...
            <select class="form-control" name="ma_bac_rank">
                ...
                foreach ($rank_select_list as $rank) {
                    if ($rank['ma_bac_rank'] == $product['ma_bac_rank']) {
                        echo '<option selected value="' . $rank['ma_bac_rank'] . '">' . $rank['ten_bac_rank'] . '</option>';
                    } else {
        ...
        <div class="col-6">
            ...
            <div class=" form-group">
                ...
                <div class="bg-light py-2 px-3 rounded border">
                    <label><input <?= !$product['dac_biet'] ? 'checked' : '' ?> name="dac_biet" value="1" class="mr-2" type="radio" checked>Đặc biệt</label>
                    <label><input <?= !$product['dac_biet'] ? 'checked' : '' ?> name="dac_biet" value="0" class="mr-2 ml-5" type="radio">Bình thường</label>
                </div>
            </div>
